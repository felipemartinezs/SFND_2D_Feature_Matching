...
int main(int argc, const char *argv[])
{
    ...
    for(auto detector_type_name:detector_type_name) // start loop detector_types
    {
        bool write_detector = false;

        for(auto descriptor_type_name:descriptor_type_name) // start loop descriptor_types
        {
